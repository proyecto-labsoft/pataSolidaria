...
export default function FormularioEditarFamiliar({data} : Props) {
    return(
        <>
                <TextInput
                    style={ styles.input }
                ...
                <Button style={{  marginVertical: 8, width: '100%',borderRadius:10}} uppercase mode="contained" onPress={() => console.log('Pressed')}>
                    Guardar cambios
                </Button>
            </>
