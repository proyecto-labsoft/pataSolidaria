...
export default function FormularioNuevoAvistamiento() {
    ...
    return(
        <View style={{gap:20,marginVertical: 16,paddingHorizontal: '5%',height: '100%',width:width,alignItems:'center'}}>
            ...
            <Button buttonColor={theme.colors.primary} textColor={theme.colors.onPrimary} style={{ marginVertical: 8,borderRadius:50}} uppercase mode="contained" onPress={() => onSumbit((e:any)=>!e)}>
                Modificar ubicación
            </Button>
            <CampoTexto
                label="Hora"
